...
<?php
$completedbet = mysql_query("SELECT bet_id,bet_title FROM tbl_bets WHERE bet_status = 'settled'");

while ($row = mysql_fetch_array($completedbet)){
	echo "<table class=\"betlist\"><tr><td><a href=\"completedsummary.php?bet_id=".$row['bet_id']."\"><b class=\"betlisttitle\">".$row['bet_title']."</b></a></td></tr></table>";
}
?>
</div>
<div id="footer">
