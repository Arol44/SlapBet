...
<div id="back">
	<?php
	echo "<a href=\"BetsUnsettled.php?id=".$_SESSION['id']."\"><img src=\"images/back.png\" /></a>";
	?>
</div>
<div id="background">
...
echo "<div id=\"donebutton\"><a href=\"addsettledbet.php?id=".$_SESSION['id']."&amp;betid=".$bet."\"><img src=\"images/done.png\" /></a></div>";

//echo "<a href=\"chooseWinner.php\"><img class=\"winner\" src=\"images/chooseWinner.png\" /></a>";
