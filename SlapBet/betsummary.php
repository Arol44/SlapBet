...
<div id="back">
	<?php
	echo "<a href=\"thewager.php?id=".$_SESSION['id']."\"><img src=\"images/back.png\" /></a>";
	?>
</div>
<div id="background">
...
<?php
$summary = mysql_query("SELECT * FROM tbl_bets WHERE bet_id=".$_SESSION['betid']);
$team1 = mysql_query("SELECT * FROM tbl_team,tbl_bets,tbl_users WHERE team_number=1 AND tbl_team.bet_id=".$_SESSION['betid']." AND tbl_users.user_id = tbl_team.user_id AND tbl_bets.bet_id=".$_SESSION['betid']);
$team2 = mysql_query("SELECT * FROM tbl_team,tbl_bets,tbl_users WHERE team_number=2 AND tbl_team.bet_id=".$_SESSION['betid']." AND tbl_users.user_id = tbl_team.user_id AND tbl_bets.bet_id=".$_SESSION['betid']);
$wager = mysql_query("SELECT * FROM tbl_wager,tbl_bets WHERE tbl_bets.wager_id = tbl_wager.wager_id AND bet_id=".$_SESSION['betid']);
...
echo "<div id=\"donebutton\"><a href=\"addunsettledbet.php?id=".$_SESSION['id']."\"><img src=\"images/done.png\" /></a></div>";
?>
</div>
<div id="footer">
